...
class TestIntelligentFallback:
    ...
    def test_prefers_openai_o3_mini_when_available(self):
        ...
        assert fallback_model == "gpt-5.5"  # Based on new preference order: gpt-5.5 is the top BALANCED flagship
    ...
    def test_prefers_gemini_flash_when_openai_unavailable(self):
        ...
        fallback_model = ModelProviderRegistry.get_preferred_fallback_model()
        assert fallback_model == "gemini-3.5-flash"
    ...
    def test_prefers_openai_when_both_available(self):
        ...
        fallback_model = ModelProviderRegistry.get_preferred_fallback_model()
        assert fallback_model == "gemini-3.5-flash"  # Gemini has priority now (based on new PROVIDER_PRIORITY_ORDER)
    ...
    def test_auto_mode_conversation_memory_integration(self):
        ...
        with (
            ...
            with patch("utils.model_context.ModelContext") as mock_context_class:
                ...
                # Verify that ModelContext was called with gpt-5.5 (the intelligent fallback based on new preference order)
    ...
    def test_auto_mode_with_gemini_only(self):
        ...
        with (
            ...
            with patch("utils.model_context.ModelContext") as mock_context_class:
                ...
                # Should use gemini-3.5-flash when only Gemini is available
                mock_context_class.assert_called_once_with("gemini-3.5-flash")
