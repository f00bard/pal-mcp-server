...
- `conf/deepseek_models.json` – native DeepSeek catalogue (`DEEPSEEK_MODELS_CONFIG_PATH`)
...
Native catalogues (`conf/openai_models.json`, `conf/gemini_models.json`, `conf/xai_models.json`, `conf/deepseek_models.json`, `conf/dial_models.json`) follow the same schema. Updating those files lets you:
